...
void setup () {
  ...
  for (int i=0; i<nbrEnemy1; i++){
    for (int j=0; j<nbrEnemy1; j++){
      ...
      enemy_y1[1]=enemy_y1[0]+1/6*spacing;
      enemy_y1[2]=enemy_y1[1]+1/6*spacing;
      enemy_y1[3]=enemy_y1[2]+1/6*spacing;
      enemy_y1[4]=enemy_y1[3]+1/6*spacing;
    }
  }
  for (int i=0; i<nbrEnemy2; i++){
    for (int j=0; j<nbrEnemy2; j++){
      ...
      enemy_y2[1]=enemy_y2[0]+1/6*spacing;
      enemy_y2[2]=enemy_y2[0]+1/6*spacing;
    }
  }
  fighterW = 51;
  fighterH = 51;
